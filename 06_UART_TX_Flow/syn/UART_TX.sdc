...
# Created by write_sdc on Wed Sep 2 03:39:27 2026
...
group_path -name INOUT  -from [list [get_ports CLK] [get_ports RST] [get_ports PAR_TYP] [get_ports PAR_EN] [get_ports {P_DATA[7]}] [get_ports {P_DATA[6]}] [get_ports {P_DATA[5]}] [get_ports {P_DATA[4]}] [get_ports {P_DATA[3]}] [get_ports {P_DATA[2]}] [get_ports {P_DATA[1]}] [get_ports {P_DATA[0]}] [get_ports DATA_VALID] [get_ports SI] [get_ports SE] [get_ports scan_clk] [get_ports scan_rst] [get_ports test_mode]]  -to [list [get_ports SO] [get_ports TX_OUT] [get_ports Busy]]
group_path -name INREG  -from [list [get_ports CLK] [get_ports RST] [get_ports PAR_TYP] [get_ports PAR_EN] [get_ports {P_DATA[7]}] [get_ports {P_DATA[6]}] [get_ports {P_DATA[5]}] [get_ports {P_DATA[4]}] [get_ports {P_DATA[3]}] [get_ports {P_DATA[2]}] [get_ports {P_DATA[1]}] [get_ports {P_DATA[0]}] [get_ports DATA_VALID] [get_ports SI] [get_ports SE] [get_ports scan_clk] [get_ports scan_rst] [get_ports test_mode]]
