...
file mkdir results_mul
file mkdir reports_mul

set RESULTS_DIR results_mul
set REPORTS_DIR reports_mul

################## Design Compiler Library Files #setup ######################

lappend search_path /home/ICer/Labs/Lab_GLS_1.0/std_cells
lappend search_path /home/ICer/Labs/Lab_GLS_1.0/rtl
...
write_file -format verilog -hierarchy -output $RESULTS_DIR/alu8_top_netlist.v
write_file -format ddc     -hierarchy -output $RESULTS_DIR/alu8_top_netlist.ddc
write_sdc  -nosplit $RESULTS_DIR/alu8_top.sdc
write_sdf            $RESULTS_DIR/alu8_top.sdf
